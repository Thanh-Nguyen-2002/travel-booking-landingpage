    ...
    return (
        <div className="bg-slate-50 min-h-screen pb-24">
            ...
            <div className="max-w-6xl mx-auto px-4">
                {/* Search Bar */}
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 mb-8 flex flex-col md:flex-row gap-4 items-center justify-between">
                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {packages.map((pkg) => {
                            const mainImage = pkg.images ? pkg.images.split(',')[0] : 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=600';
                                ...
                                >
                                    <div className="relative h-56 overflow-hidden">
                                        ...
                                        {pkg.destination?.name && (
                                            <div className="absolute top-4 left-4">
                                                <span className="inline-flex items-center gap-1 px-3 py-1 bg-white/95 backdrop-blur-md text-primary-600 text-xs font-bold rounded-lg shadow-sm">
                                    ...
                                    <div className="p-6 flex flex-col grow">
                                        ...
                                        <div className="mt-auto pt-4 border-t border-slate-50 flex items-end justify-between">
                                            ...
                                            <span className="text-sm font-bold text-primary-600 group-hover:underline flex items-center gap-1">
                                                Chi tiết →
                                            </span>
                                        </div>
                                    </div>
