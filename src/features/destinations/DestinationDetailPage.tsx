    ...
    return (
        <div className="bg-slate-50 min-h-screen pb-24">
            ...
            <div className="relative h-[60vh] min-h-[400px] w-full overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 md:p-16 text-white container mx-auto max-w-6xl z-10">
            ...
            <div className="container mx-auto px-4 max-w-6xl -mt-8 relative z-20">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        <div className="bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-slate-100/50 p-6 sticky top-24">
