...
import { Shield, Database, LockKeyhole, Share2, UserCog, BadgeCheck, AlertCircle } from 'lucide-react';
            ...
            <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-primary-900 py-32 text-center text-white overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 flex flex-col items-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight">
                        Chính sách <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-teal-300">Bảo mật</span>
                    </h1>
